...
import playfulCat from '@/assets/undraw_playful-cat_3ta5.svg'
    ...
    <div class="container">
      ...
      <div class="hero-section">
        <div class="hero-inner">
          <div class="hero-copy">
            <h1 class="hero-title">喵绘网页</h1>
            <p class="hero-description">一句话轻松创建网站应用</p>
          </div>
          <div class="hero-illustration">
            <img :src="welcomeCats" alt="欢迎来到喵绘网页的猫咪插画" />
          </div>
        </div>
        <img class="hero-floating-cat" :src="playfulCat" alt="可爱的猫咪插画装饰" />
      </div>
...
.hero-floating-cat {
  ...
  animation: floatCat 6s ease-in-out infinite alternate;
  z-index: 1;
}
