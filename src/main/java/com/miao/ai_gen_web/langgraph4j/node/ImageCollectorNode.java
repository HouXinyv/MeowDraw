...
import com.miao.ai_gen_web.langgraph4j.ai.ImageCollectionPlanService;
import com.miao.ai_gen_web.langgraph4j.ai.ImageCollectionService;
import com.miao.ai_gen_web.langgraph4j.model.ImageCollectionPlan;
    ...
    public static AsyncNodeAction<MessagesState<String>> create() {
        return node_async(state -> {
            ...
            try {
                ...
                // 第二步：并发执行各种图片收集任务  每一种类型，内部每一个query，都会被加入进去，然后一起并发执行
