package com.miao.ai_gen_web.monitor;
...
//    如果把各种计数器（Counter）、计时器（Timer）比作**“传感器”，那么 MeterRegistry 就是那台“显示器”或“中央控制台”**
    @Resource
    ...
    public void recordRequest(String userId, String appId, String modelName, String status) {
        ...
        Counter counter = requestCountersCache.computeIfAbsent(key, k -> // abasent 缺失
